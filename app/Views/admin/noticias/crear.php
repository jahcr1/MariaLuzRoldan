...
<div class="d-flex justify-content-between align-items-center mb-4">
    <h1 class="h3 mb-0"><i class="fas fa-newspaper me-2"></i>Crear Nueva Noticia</h1>
...
<div class="card border-0 shadow-sm">
    <div class="card-body">
        <form action="<?= APP_URL ?>/admin/noticias/guardar" method="post" enctype="multipart/form-data">
            <div class="row">
                <div class="col-md-8">
                    <!-- Título -->
                    <div class="mb-3">
                ...
                <div class="col-md-4">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="date" class="form-control <?= isset($errores['fecha_publicacion']) ? 'is-invalid' : '' ?>" 
                               ...
                               value="<?= htmlspecialchars($noticia['fecha_publicacion'] ?? date('Y-m-d')) ?>" required>
